...
from utils.experiments.evaluation import derive_main_experiment
from utils.experiments.metrics import calculate_metrics_for_predictions
from utils.experiments.model import save_model, save_model_based_on_thresholds, visualize_model
...
from utils.misc.logger import get_experiment_logdir
...
class CustomCallbackV1(Callback):
    def __init__(self, x_val, y_val, y_classes, record_ids_val, experiment, experiment_logdir, tensorboard_logdir, metrics=None, calculation_methods=None, class_names_to_log=None, metric_thresholds=None):
        ...
        self.main_experiment = derive_main_experiment(self.experiment)
        self.experiment_logdir = experiment_logdir
        self.main_experiment_logdir = get_experiment_logdir(self.main_experiment)
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        save_model(self.model, self.experiment_logdir, epoch)
